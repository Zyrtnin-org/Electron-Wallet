...
| 2 | Glyph NFT singleton (direct APDU) | [`af0cd27d9cda2113cc9882274ff7015f09f759ffe8b71b0c17e86c64fb6201c9`](https://explorer.radiantblockchain.org/tx/af0cd27d9cda2113cc9882274ff7015f09f759ffe8b71b0c17e86c64fb6201c9) | [`radiant-ledger-app`](https://github.com/Zyrtnin-org/radiant-ledger-app) — `spend_real_glyph_2in.py` extended for transfer | 63-byte NFT-holder template output; device-computed `hashOutputHashes`. 2026-04-16. |
...
| 4 | Glyph NFT singleton (wallet-integrated) | [`a323dfc543834eaf035a273b2d0b9f545683085c8ec7202af0e25a16715a3be1`](https://explorer.radiantblockchain.org/tx/a323dfc543834eaf035a273b2d0b9f545683085c8ec7202af0e25a16715a3be1) | **this wallet** — `electroncash_plugins/ledger` + `btchip` + `send_nft` console command + NFTs-tab GUI dialog | First Glyph NFT transferred through a full wallet integration — UTXO selection, fee calculation, RXD change routing, GUI dialog. 2026-04-20. |

Rows 1 and 2 used a direct-APDU harness (minimal host wrapping around the Ledger protocol). Rows 3 and 4 are the first Radiant Glyph assets signed through a full wallet integration with UTXO selection, fee calculation, and change routing — the prerequisite for end-user Ledger signing.
